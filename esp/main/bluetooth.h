...
uint16_t leds_color_handle_table[HRS_IDX_NB];
...
static struct gatts_profile_inst leds_color_profile_tab[PROFILE_NUM] = {
    [PROFILE_APP_IDX] = {
...
static const uint16_t GATTS_CHAR_UUID_TEST_RGB     = 0xFF01;
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_CHAR_VAL_RGB] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TEST_RGB, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      INPUT_DATA_CHAR_LEN_MAX, sizeof(char_value), (uint8_t *)char_value}},

    /* Client Characteristic Configuration Descriptor */
    [IDX_CHAR_CFG_RGB]  =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      sizeof(uint16_t), sizeof(leds_color_rgb), (uint8_t *)leds_color_rgb}},
};
    ...
    switch (event) {
            ...
            if (!param->write.is_prep){
                ...
                if (leds_color_handle_table[IDX_CHAR_CFG_RGB] == param->write.handle && param->write.len == 2){
                    ...
                    if (descr_value == 0x0001){
                        ...
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, leds_color_handle_table[IDX_CHAR_VAL_RGB],
                        ...
                        // esp_ble_gatts_set_attr_value(leds_color_handle_table[IDX_CHAR_VAL_RGB], sizeof(indicate_data), indicate_data);
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT:{
            if (param->add_attr_tab.status != ESP_GATT_OK){
                ...
                memcpy(leds_color_handle_table, param->add_attr_tab.handles, sizeof(leds_color_handle_table));
                esp_ble_gatts_start_service(leds_color_handle_table[IDX_SVC]);
            }
            break;
        }
...
static void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    if (event == ESP_GATTS_REG_EVT) {
        if (param->reg.status == ESP_GATT_OK) {
            leds_color_profile_tab[PROFILE_APP_IDX].gatts_if = gatts_if;
        } else {
    ...
    do {
        ...
        for (idx = 0; idx < PROFILE_NUM; idx++) {
            ...
            if (gatts_if == ESP_GATT_IF_NONE || gatts_if == leds_color_profile_tab[idx].gatts_if) {
                if (leds_color_profile_tab[idx].gatts_cb) {
                    leds_color_profile_tab[idx].gatts_cb(event, gatts_if, param);
                }
            }
        }
    } while (0);
