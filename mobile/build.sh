...
sudo javac --release 11 -classpath "$PLATFORM/android.jar" -d build/obj build/gen/com/example/leds_mobile/R.java src/com/example/leds_mobile/MainActivity.java src/com/example/leds_mobile/BluetoothService.java src/com/example/leds_mobile/Secrets.java && \
